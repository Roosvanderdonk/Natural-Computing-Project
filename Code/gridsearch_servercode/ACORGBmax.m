function [ pheromone_map ] = ACORGBmax( image, heuristic_name, ant_creation_name, ant_initialization_name, ant_possible_step_name, num_iterations, ant_num_steps, ant_memory_length, alpha, beta, rho, phi)
...
[pheromone_map, ~] = max(pheromone_maps,[],3);
