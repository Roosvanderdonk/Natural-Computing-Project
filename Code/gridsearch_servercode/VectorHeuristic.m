function [ heuristic_map ] = VectorHeuristic( input_image )
%VECTORHEURISTIC Calculates a heuristic for ACO from an RGB image
%   It takes the euclidean distance between pixels after the image has been
%   converted to HSV
