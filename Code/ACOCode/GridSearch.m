...
%EVALUATEPARAMETERS Evaluates different settings of parameters for the
                ...
                for beta = 1: length(possible_beta)
                    for rho = 1: length(possible_rho)
                        for phi = 1: length(possible_phi)
                            ...
                            % Get input_files
                            input_file = strcat('..\..\dataset\', imageindex, '.jpg');
                            edge_file = strcat('..\..\dataset\', imageindex, '_edge.jpg');
...
filename = ['gridsearch_' method '_' str(imageindex) '.mat']
save(filename, 'final_results')
